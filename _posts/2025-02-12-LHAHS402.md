...
*Tartarus did manage to extract Aaron's Hero Record fragments to grant transformation abilities, but... that transformation isn't possible without a fake Brave, so it's a different case.*
